...
fun DeleteAccountsScreen(
    deleteAccountsViewModel: AccountsManagementViewModel
    )
{
    ...
    Column(
        ...
        state.showDialog,
        {
            deleteAccountsViewModel.onEventUser(AccountUiEvent.OnConfirm(state.accountId))
        }
        ) {deleteAccountsViewModel.onEventUser(AccountUiEvent.OnCloseDialog) }
    }
}
